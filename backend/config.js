const { DEFAULT_SCREEN_CAPTURE_FPS, normalizeScreenFps } = require('./fps');
...
const SCREEN_CAPTURE_FPS = normalizeScreenFps(process.env.SCREEN_FPS, DEFAULT_SCREEN_CAPTURE_FPS);
